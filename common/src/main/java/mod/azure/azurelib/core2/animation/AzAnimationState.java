 ...
 */
public class AzAnimationState<T> {
    ...
    /**
     * Gets the current {@link T animatable} being rendered
     */
    ...
    /**
     * Gets whether the current {@link T animatable} is considered to be moving for animation purposes.<br>
    ...
    /**
     * Gets the current {@link AzAnimationController} responsible for the current animation
     */
    ...
    /**
     * Sets the {@code AnimationEvent}'s current {@link AzAnimationController}
     */
    public AzAnimationState<T> withController(AzAnimationController<T> controller) {
     ...
     */
    public void setAnimation(AzRawAnimation animation) {
        getController().setAnimation(animatable, animation);
    }

    /**
     * Helper method to set an animation to start/continue playing, and return {@link PlayState#CONTINUE}
     */
    public PlayState setAndContinue(AzRawAnimation animation) {
        getController().setAnimation(animatable, animation);
    ...
    /**
     * Checks whether the current {@link AzAnimationController}'s last animation was the one provided. This allows for
     ...
     */
    public boolean isCurrentAnimation(AzRawAnimation animation) {
    ...
    /**
     * Helper method for {@link AzAnimationController#forceAnimationReset()}<br>
    ...
    /**
     * Helper method for {@link AzAnimationController#setAnimationSpeed}
     *
