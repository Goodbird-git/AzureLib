...
public final class DefaultAnimations {
	 ...
	 * Recommended:
	 * <ul>
	 *     <li>{@link mod.azure.azurelib.animatable.GeoEntity GeoEntity}: state -> animatable</li>
	 *     <li>{@link mod.azure.azurelib.animatable.GeoBlockEntity GeoBlockEntity}: state -> animatable</li>
	 *     <li>{@link mod.azure.azurelib.animatable.GeoReplacedEntity GeoReplacedEntity}: state -> state.getData(DataTickets.ENTITY)</li>
	 *     <li>{@link mod.azure.azurelib.animatable.GeoItem GeoItem}: state -> state.getData(DataTickets.ITEMSTACK)</li>
