 ...
 */
public abstract class DynamicObjectItemRenderer<T extends GeoAnimatable> extends GeoObjectRenderer<T> {
    ...
    protected DynamicObjectItemRenderer(GeoModel<T> model) {
        super(model);
    }
