 ...
 * of this action.
 */
public record AzRootSetTransitionInSpeedAction(
    double transitionSpeed
) implements AzDispatchAction {

    public static final StreamCodec<FriendlyByteBuf, AzRootSetTransitionInSpeedAction> CODEC = StreamCodec.composite(
        ByteBufCodecs.DOUBLE,
        AzRootSetTransitionInSpeedAction::transitionSpeed,
        AzRootSetTransitionInSpeedAction::new
    );
