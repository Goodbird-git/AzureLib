...
public final class AzureLibCache {
	private static final List<String> EXCLUDED_NAMESPACES = Arrays.asList("geckolib3", "animatedmobsmod", "moreplayermodels", "customnpcs", "dungeons_mobs", "gunsrpg", "mimic", "celestisynth", "the_flesh_that_hates", "enemyexpansion", "mutationcraft", "born_in_chaos_v1");
	...
	public static void registerReloadListener() {
		...
		if (!(mc.getResourceManager() instanceof ReloadableResourceManager))
			throw new AzureLibException("AzureLib was initialized too early!");

		((ReloadableResourceManager) mc.getResourceManager()).registerReloadListener(AzureLibCache::reload);
	}
