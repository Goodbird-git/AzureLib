 ...
 * <pre>{@code
 *
 * public static final Supplier<SimpleParticleType> TEST = CommonParticleRegistryInterface.registerParticle(
 *     "modid",
 *     "particlename",
 ...
 * </p>
 * <ul>
 * <li><code>registerParticle</code> is a method to register a new particle with the specified mod ID and particle
 * name.</li>
 * <li><code>SimpleParticleType</code> is used to create a new particle type instance.</li>
 * </ul>
 * <p>
 * The {@link net.minecraft.core.particles.SimpleParticleType SimpleParticleType} class represents a basic particle type
 * in the game.
 * </p>
 */
public interface CommonParticleRegistryInterface {
     ...
     */
    static <T extends ParticleType<?>> Supplier<T> registerParticle(
        String modID,
        String particleName,
        Supplier<T> particle
    ) {
