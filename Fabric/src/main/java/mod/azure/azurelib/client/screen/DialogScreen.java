...
public class DialogScreen extends Screen {
    ...
    public static final Component TEXT_CONFIRM = new TranslatableComponent("text.azurelib.screen.dialog.confirm");
    public static final Component TEXT_CANCEL = new TranslatableComponent("text.azurelib.screen.dialog.cancel");
