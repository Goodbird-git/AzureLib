...
public class AzAnimationTimer {
    ...
    public void tick() {
        ...
        double currentRenderTick = RenderUtils.getCurrentTick();
        ...
        double deltaRenderTick = currentRenderTick - lastGameTickTime;

        if (wasPausedLastFrame && !minecraft.isGamePaused()) {
