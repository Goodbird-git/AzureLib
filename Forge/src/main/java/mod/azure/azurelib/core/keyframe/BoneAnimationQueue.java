...
public class BoneAnimationQueue {
	...
	private AnimationPointQueue rotationYQueue;
	private AnimationPointQueue rotationZQueue;
	private AnimationPointQueue positionXQueue;
	private AnimationPointQueue positionYQueue;
	private AnimationPointQueue positionZQueue;
	private AnimationPointQueue scaleXQueue;
	private AnimationPointQueue scaleYQueue;
	private AnimationPointQueue scaleZQueue;
	 ...
	 * @param transitionLength The length of the transition (based on the {@link mod.azure.azurelib.core.animation.AnimationController})
	 ...
	 * @param keyFrame The {@code Nullable} Keyframe relevant to the animation point
	 * @param lerpedTick The lerped time (current tick + partial tick) that the point starts at
	 * @param transitionLength The length of the transition (base on the {@link mod.azure.azurelib.core.animation.AnimationController}
