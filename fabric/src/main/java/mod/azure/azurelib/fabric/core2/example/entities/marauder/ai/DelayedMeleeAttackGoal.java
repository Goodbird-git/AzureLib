package mod.azure.azurelib.fabric.core2.example.entities.marauder.ai;
...
public class DelayedMeleeAttackGoal extends Goal {
    ...
    public void tick() {
        ...
        if (livingentity != null) {
            ...
            if (!this.mob.level().isClientSide() && this.mob.getTarget() != null && this.mob.isWithinMeleeAttackRange(this.mob.getTarget())) {
    ...
    protected boolean canPerformAttack(LivingEntity entity) {
        return this.delayCounter > 60 && this.isTimeToAttack() && this.mob.isWithinMeleeAttackRange(entity) && this.mob.getSensing().hasLineOfSight(entity);
    }
