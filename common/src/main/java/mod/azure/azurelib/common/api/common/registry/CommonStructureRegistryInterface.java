 ...
 * <pre>{@code
 *
 * public static final Supplier<StructureType<CustomStructure>> TEST = CommonStructureRegistryInterface
 ...
 * </p>
 * <ul>
 * <li><code>registerStructure</code> is a method to register a new structure type with the specified mod ID and
 * structure name.</li>
...
public interface CommonStructureRegistryInterface {
     ...
     */
    static <T extends Structure> Supplier<StructureType<T>> registerStructure(
        String modID,
