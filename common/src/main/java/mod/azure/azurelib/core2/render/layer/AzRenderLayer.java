...
public abstract class AzRenderLayer<T> {
    ...
    /**
     * This method is called by the {@link AzRendererPipeline} before rendering, immediately after {@link AzRendererPipeline#preRender} has been called.<br>
     * This allows for RenderLayers to perform pre-render manipulations such as hiding or showing bones
     */
    public abstract void preRender(PoseStack poseStack, T animatable, AzBakedModel bakedModel, RenderType renderType,
     ...
     */
    public abstract void render(PoseStack poseStack, T animatable, AzBakedModel bakedModel, RenderType renderType,
                                MultiBufferSource bufferSource, VertexConsumer buffer, float partialTick,
                                int packedLight, int packedOverlay);
     ...
     */
    public abstract void renderForBone(PoseStack poseStack, T animatable, AzBone bone, RenderType renderType,
