...
public class SmartBrainProvider<E extends LivingEntity & SmartBrainOwner<E>> extends Brain.Provider<E> {
	...
	/**
	 * Use one of the startup 'getTasks' methods if adding at startup, or else use {@link mod.azure.azurelib.sblforked.util.BrainUtils#addActivity(Brain, BrainActivityGroup)}
	 */
