...
public @interface Config {
    ...
    /**
     * Allows you to customize your config filename. Your custom filename must be valid according to your operating
     * system, otherwise {@link java.io.IOException} will be raised during config processing. Using {@code empty} string
     * as filename will use your {@link Config#id()} value as default.
     *
    ...
    /**
     * Allows you to group multiple configs under one identifier. Useful when you have 2 or more config files which
     * should be accessible via GUI.
     *
