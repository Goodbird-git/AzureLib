...
/**
 * The {@code AzRootSetTransitionSpeedAction} class implements the {@link AzDispatchAction} interface and represents
 * an action that modifies the transition speed for an animator during an animation state. This action is intended
