...
public class AzureBlocksRegistry implements CommonBlockRegistryInterface {
    ...
    public static final Supplier<TickingLightBlock> TICKING_LIGHT_BLOCK = CommonBlockRegistryInterface.registerBlock(AzureLib.MOD_ID, "lightblock", () -> new TickingLightBlock(
